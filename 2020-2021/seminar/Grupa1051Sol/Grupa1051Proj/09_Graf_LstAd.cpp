...
// TO DO:
// creare graf cu matrice de adiacenta ca structura suport
// traversari DF si BF cu graf stocat ca matrice de adiacenta
...
void main() {
	...
	while (pListaAdiacenta)
	{
		...
		while (tmpLP->primListaVecini)
		{
			...
			free(tmpLS); // dezalocare nod LS
		}

		// lista secundara pentru tmpLP a fost dezalocata
		free(tmpLP);
	}
