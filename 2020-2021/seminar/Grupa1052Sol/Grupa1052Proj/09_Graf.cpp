...
unsigned int* DF(NodLP* pLP, unsigned int start, unsigned int nrVarfuri) {
	...
	while (stack) {
		...
		NodLP* tmpLP = cautaNodLP(pLP, varf); // adresa nod LP care contine varf
...
// TO DO: 
// creare strctura graf reprezentat prin matrice de adiacenta
// traversari DF si BF pentru graf reprezentat prin matrice de adiacenta
